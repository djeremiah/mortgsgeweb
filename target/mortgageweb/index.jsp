...
<style>
  ...
  <div class="container-fluid" ng-controller="caseCtrl"   />
   <div class="row">
         <div class="col-md-9 ">
      <!-- Static navbar -->
      <div class="navbar navbar-default">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Red Hat BPM - Mortgage demo</a>
        </div>
			...
			<div class="col-md-3 panel-group" id="accordion">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#/Admin">New Mortgage Process</a>
							<!-- a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#panel1">Credit Dispute Process</a> -->
						</h4>
					</div>
					<div id="panel1" class="panel-collapse collapse">
						<div class="panel-body">
							<li><a href="#/Admin">Create New Mortgage Application</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							...
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#/Cases">Mortgage process </a>
						</h4>
					</div>
					<div id="panel2" class="panel-collapse collapse">
						<div class="panel-body">
							<li><a href="#/Cases">Mortgage</a></li>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<!-- <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#panel2">All Cases </a> -->
							<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#/usertasks">Tasks </a>
						</h4>
					</div>
					<div id="panel3" class="panel-collapse collapse">
						<div class="panel-body">
							<li><a href="#/usertasks">User task</a></li>
